...
public class TestsGlobalContext {
	...
	public static String consistentFeatureModelXMLFile = "src/test/resources/tests/test_fm_consistent.xml"; 
	public static String inconsistentFeatureModelXMLFile = "src/test/resources/tests/test_fm_inconsistent.xml"; 
	...
	public static String configurationFeatureModelXMLFile = "src/test/resources/tests/test_fm_configuration.xml"; 
